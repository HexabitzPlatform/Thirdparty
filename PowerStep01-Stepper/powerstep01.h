/*
 ...
 File Name     : powerstep01.h
 Description   : Header for Powerstep01 motor driver (Microstepping controller with power MOSFETs)
 */
...
typedef enum {
	...
	POWERSTEP01_TOFF_FAST_10us = (((uint8_t) 0x04)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_12us = (((uint8_t) 0x05)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_14us = (((uint8_t) 0x06)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_16us = (((uint8_t) 0x07)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_18us = (((uint8_t) 0x08)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_20us = (((uint8_t) 0x09)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_22us = (((uint8_t) 0x0A)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_24us = (((uint8_t) 0x0B)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_26us = (((uint8_t) 0x0C)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_28us = (((uint8_t) 0x0D)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_30us = (((uint8_t) 0x0E)
			<< POWERSTEP01_TOFF_FAST_SHIFT),
	POWERSTEP01_TOFF_FAST_32us = (((uint8_t) 0x0F)
			<< POWERSTEP01_TOFF_FAST_SHIFT)
...
typedef enum {
	POWERSTEP01_CONFIG_PWM_DIV_1 = (((uint16_t) 0x00)
			<< POWERSTEP01_CONFIG_PWM_DIV_SHIFT),
	POWERSTEP01_CONFIG_PWM_DIV_2 = (((uint16_t) 0x01)
			<< POWERSTEP01_CONFIG_PWM_DIV_SHIFT),
	POWERSTEP01_CONFIG_PWM_DIV_3 = (((uint16_t) 0x02)
			<< POWERSTEP01_CONFIG_PWM_DIV_SHIFT),
	POWERSTEP01_CONFIG_PWM_DIV_4 = (((uint16_t) 0x03)
			<< POWERSTEP01_CONFIG_PWM_DIV_SHIFT),
	POWERSTEP01_CONFIG_PWM_DIV_5 = (((uint16_t) 0x04)
			<< POWERSTEP01_CONFIG_PWM_DIV_SHIFT),
	POWERSTEP01_CONFIG_PWM_DIV_6 = (((uint16_t) 0x05)
			<< POWERSTEP01_CONFIG_PWM_DIV_SHIFT),
	POWERSTEP01_CONFIG_PWM_DIV_7 = (((uint16_t) 0x06)
			<< POWERSTEP01_CONFIG_PWM_DIV_SHIFT)
} powerstep01_ConfigFPwmInt_t;

/// PWM frequency multiplication factor (F_PWM_DEC field of CONFIG register of Powerstep01)
typedef enum {
	POWERSTEP01_CONFIG_PWM_MUL_0_625 = (((uint16_t) 0x00)
			<< POWERSTEP01_CONFIG_PWM_MUL_SHIFT),
	POWERSTEP01_CONFIG_PWM_MUL_0_75 = (((uint16_t) 0x01)
			<< POWERSTEP01_CONFIG_PWM_MUL_SHIFT),
	POWERSTEP01_CONFIG_PWM_MUL_0_875 = (((uint16_t) 0x02)
			<< POWERSTEP01_CONFIG_PWM_MUL_SHIFT),
	POWERSTEP01_CONFIG_PWM_MUL_1 = (((uint16_t) 0x03)
			<< POWERSTEP01_CONFIG_PWM_MUL_SHIFT),
	POWERSTEP01_CONFIG_PWM_MUL_1_25 = (((uint16_t) 0x04)
			<< POWERSTEP01_CONFIG_PWM_MUL_SHIFT),
	POWERSTEP01_CONFIG_PWM_MUL_1_5 = (((uint16_t) 0x05)
			<< POWERSTEP01_CONFIG_PWM_MUL_SHIFT),
	POWERSTEP01_CONFIG_PWM_MUL_1_75 = (((uint16_t) 0x06)
			<< POWERSTEP01_CONFIG_PWM_MUL_SHIFT),
	POWERSTEP01_CONFIG_PWM_MUL_2 = (((uint16_t) 0x07)
			<< POWERSTEP01_CONFIG_PWM_MUL_SHIFT)
} powerstep01_ConfigFPwmDec_t;

/// Switching period  (TSW field of CONFIG register of Powerstep01)
typedef enum {
	POWERSTEP01_CONFIG_TSW_004us = (((uint16_t) 0x01)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_008us = (((uint16_t) 0x02)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_012us = (((uint16_t) 0x03)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_016us = (((uint16_t) 0x04)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_020us = (((uint16_t) 0x05)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_024us = (((uint16_t) 0x06)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_028us = (((uint16_t) 0x07)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_032us = (((uint16_t) 0x08)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_036us = (((uint16_t) 0x09)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_040us = (((uint16_t) 0x0A)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_044us = (((uint16_t) 0x0B)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_048us = (((uint16_t) 0x0C)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_052us = (((uint16_t) 0x0D)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_056us = (((uint16_t) 0x0E)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_060us = (((uint16_t) 0x0F)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_064us = (((uint16_t) 0x10)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_068us = (((uint16_t) 0x11)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_072us = (((uint16_t) 0x12)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_076us = (((uint16_t) 0x13)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_080us = (((uint16_t) 0x14)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_084us = (((uint16_t) 0x15)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_088us = (((uint16_t) 0x16)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_092us = (((uint16_t) 0x17)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_096us = (((uint16_t) 0x18)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_100us = (((uint16_t) 0x19)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_104us = (((uint16_t) 0x1A)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_108us = (((uint16_t) 0x1B)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_112us = (((uint16_t) 0x1C)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_116us = (((uint16_t) 0x1D)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_120us = (((uint16_t) 0x1E)
			<< POWERSTEP01_CONFIG_TSW_SHIFT),
	POWERSTEP01_CONFIG_TSW_124us = (((uint16_t) 0x1F)
			<< POWERSTEP01_CONFIG_TSW_SHIFT)
...
typedef enum {
	POWERSTEP01_STATUS_MOT_STATUS_STOPPED = (((uint16_t) 0x0000)
			<< POWERSTEP01_STATUS_MOT_STATUS_SHIFT),
	POWERSTEP01_STATUS_MOT_STATUS_ACCELERATION = (((uint16_t) 0x0001)
			<< POWERSTEP01_STATUS_MOT_STATUS_SHIFT),
	POWERSTEP01_STATUS_MOT_STATUS_DECELERATION = (((uint16_t) 0x0002)
			<< POWERSTEP01_STATUS_MOT_STATUS_SHIFT),
	POWERSTEP01_STATUS_MOT_STATUS_CONST_SPD = (((uint16_t) 0x0003)
			<< POWERSTEP01_STATUS_MOT_STATUS_SHIFT)
...
/* Motor_Driver_Initialization_Structure Motor Driver Initialization Structure */
...
/* MotorControl_Board_Linked_Functions MotorControl Board Linked Functions */
...
extern uint8_t Powerstep01_Board_SpiWriteBytes(uint8_t *pByteToTransmit,
		uint8_t *pReceivedByte, uint8_t nbDevices); //Write bytes to the powerSTEP01s via SPI
