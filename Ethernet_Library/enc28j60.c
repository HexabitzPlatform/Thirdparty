/*
 * enc28j60.c
 * Description:ethernet  Source file
...
#define enc28j60_select()   HAL_GPIO_WritePin(C_SELECT_PORT, C_SELECT_PIN, GPIO_PIN_RESET);
#define enc28j60_release()  HAL_GPIO_WritePin(C_SELECT_PORT, C_SELECT_PIN, GPIO_PIN_SET);
